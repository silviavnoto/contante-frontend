...
@Component({
  selector: 'app-asiento-xtipoasiento-admin-routed',
  templateUrl: './asiento.xtipoasiento.admin.plist.routed.component.html',
  styleUrls: ['./asiento.xtipoasiento.admin.plist.routed.component.css'],
  standalone: true,
  imports: [CommonModule, FormsModule, TrimPipe, RouterModule],
})
export class AsientoXTipoasientoAdminPlistRoutedComponent implements OnInit {
  ...
  constructor(
    ...
    this.oActivatedRoute.params.subscribe((params) => {
      this.oTipoAsientoService.get(params['id']).subscribe({
